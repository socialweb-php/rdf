...
/**
 * Thrown when a term, quad, or option is constructed from an invalid value
 */
final class InvalidArgument extends InvalidArgumentException implements RdfException
{
}
