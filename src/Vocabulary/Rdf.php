...
namespace SocialWeb\Rdf\Vocabulary;

/**
 * IRIs from the RDF vocabulary
 *
 * @link https://www.w3.org/1999/02/22-rdf-syntax-ns#
 */
final class Rdf
{
    public const string LANG_STRING = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#langString';
}
