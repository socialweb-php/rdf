...
* GitHub Issues: <https://github.com/socialweb-php/rdf/issues>
...
* socialweb/rdf follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  socialweb/rdf automatically runs tests for pull requests. However,
...
[github]: https://github.com/socialweb-php/rdf
[issues]: https://github.com/socialweb-php/rdf/issues
[pull requests]: https://github.com/socialweb-php/rdf/pulls
